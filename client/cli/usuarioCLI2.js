...
function launchModule(scriptPath, user) {
    ...
    try {
        // Ejecutamos el script y le pasamos el ID y el correo del usuario como argumentos
        // stdio: 'inherit' permite que el subproceso use la misma consola que este script
